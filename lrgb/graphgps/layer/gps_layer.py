...
from graphgps.layer.pygnn_orthogonal_gcn import OrthogonalGCNConvLayer
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        elif local_gnn_type == "OrthogonalGCN":
            self.local_gnn_with_edge_attr = False
            self.local_model = OrthogonalGCNConvLayer(dim_h, dim_h)
